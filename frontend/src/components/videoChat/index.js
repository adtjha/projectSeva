    ...
    return (
        <React.Fragment>
            <>
                ...
                ></div>
                <div className="col-start-1 col-end-2 row-start-6 row-end-7 flex justify-center items-center flex-wrap opacity-40">
                    <svg
                ...
                <div className="col-start-6 col-end-7 row-start-6 row-end-7 flex justify-center items-center flex-wrap opacity-40">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-6 w-6 stroke-current text-gray-400"
                        fill="none"
            ...
            <>
                ...
                ></div>
                <div className="col-start-10 col-end-11 row-start-1 row-end-2 flex justify-center items-center flex-wrap opacity-40">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-6 w-6 stroke-current text-gray-400"
                        fill="none"
                ...
                <div className="col-start-10 col-end-11 row-start-6 row-end-7 flex justify-center items-center flex-wrap opacity-40">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-6 w-6 stroke-current text-gray-400"
                        fill="none"
            ...
            <>
                ...
                ></div>
                <div className="col-start-6 col-end-7 row-start-10 row-end-11 flex justify-center items-center flex-wrap opacity-40">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-6 w-6 stroke-current text-gray-400"
                        fill="none"
                ...
                <div className="col-start-6 col-end-7 row-start-15 row-end-16 flex justify-center items-center flex-wrap opacity-40">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-6 w-6 stroke-current text-gray-400"
                        fill="none"
            ...
            <>
                ...
                ></div>
                <div className="col-start-10 col-end-11 row-start-10 row-end-11 flex justify-center items-center flex-wrap opacity-40">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-6 w-6 stroke-current text-gray-400"
                        fill="none"
                ...
                <div className="col-start-15 col-end-16 row-start-10 row-end-11 flex justify-center items-center flex-wrap opacity-40">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-6 w-6 stroke-current text-gray-400"
                        fill="none"

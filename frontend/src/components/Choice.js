...
export const Choice = ({ values, room, setRoom, handleSubmit }) => {
    return (
        <div
        ...
        >
            <div className="w-5/6 h-16 items-center justify-end my-4 mx-auto flex flex-row">
                ...
                <div className="w-16 h-16 flex flex-row">
                    <img
                        ...
                        src={`https://avatars.dicebear.com/api/${values[0].avatar}.svg?background=%23F1F5F9`}
                        alt="avatar" />
                </div>
            </div>
            ...
            <div className="w-full text-center text-4xl opacity-20">- OR -</div>

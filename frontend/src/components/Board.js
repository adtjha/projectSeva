...
const Board = (props) => {
    ...
    return (
        <React.Fragment>
            ...
            <div className="board block w-107 h-107 transform scale-95 -mx-2 sm:m-auto min-w-max min-h-max lg:w-157 lg:h-157 lg:p-4 p-1 border-2 border-solid rounded-2xl shadow-md">
